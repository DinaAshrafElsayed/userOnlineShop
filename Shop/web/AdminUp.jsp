            ...
            <section class="sidebar">
                ...
                <ul class="sidebar-menu">
                    ...
                    <li class="treeview">
                        ...
                        <ul class="treeview-menu">
                            <li><a href="UsersHasOrders"><i class="fa fa-angle-double-right"></i> Show All Orders</a></li>
                    ...
                    <li class="treeview">
                        ...
                        <ul class="treeview-menu">
                            <li><a href="GetAllUsers"><i class="fa fa-angle-double-right"></i> Show All Users</a></li>
